...
describe('文字列でのインスタンス化', () => {
    const jst = new JST_1.JST('2021-12-31T23:07:02.123Z');
    it('値チェック', () => expect(jst.format('yyyymmdd HHMMSS.sss E')).toBe('20220101 080702.123 土'));
});
//# sourceMappingURL=JST.test.js.map